 ...
 * @author Emanuel CB
 */
public class FrmEliminarTecnico extends javax.swing.JInternalFrame {

    private ControladorTecnicos ctt;
    private Tecnico tecnicos;

    public FrmEliminarTecnico() {
        initComponents();
        ...
        if (cajaCedula.getText().isEmpty()) {
            ...
            try {
                ...
                if(ctt.eliminarTecnico(tecnicos)){
                    ...
                    JOptionPane.showMessageDialog(this, "Tecnico NO eliminado");
                }

            } catch (Exception e) {
                  
                    JOptionPane.showMessageDialog(this, "ERROR AL ELIMINAR Tecnico DEVIDO A "+e.getMessage());
