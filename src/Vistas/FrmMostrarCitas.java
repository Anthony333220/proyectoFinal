 ...
 * @author Emmanuel
 */
public class FrmMostrarCitas extends javax.swing.JDialog {
     ...
     * @param parent
     */
    public FrmMostrarCitas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        citas = new ArrayList();
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        if( (citas=ctlc.listarPorFecha(cita))!= null )
        {
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        vehiculo.setPlaca(Integer.valueOf((String)this.jTable1.getValueAt(seleccion, 2)));
        cita.setVehiculo(ctlv.buscarVehiculo(vehiculo));
    ...
    public void mostrar(){
        ...
        for (int i = 0; i < citas.size(); i++) {
            ...
            matriz[i][2]=String.valueOf(citas.get(i).getVehiculo().getPlaca());
            
        }
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            matriz,new String [] {"Fecha", "Hora","vehiculo"}));
    }
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMostrarCitas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmMostrarCitas dialog = new FrmMostrarCitas(new javax.swing.JFrame(), true);
